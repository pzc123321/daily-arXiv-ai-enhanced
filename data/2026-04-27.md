...
### [30] [Depth-Aware Rover: A Study of Edge AI and Monocular Vision for Real-World Implementation](https://arxiv.org/abs/2604.22331)
...
### [79] [Shard the Gradient, Scale the Model: Serverless Federated Aggregation via Gradient Partitioning](https://arxiv.org/abs/2604.22072)
*Amine Barrak*
...
### [80] [FlashSpread: IO-Aware GPU Simulation of Non-Markovian Epidemic Dynamics via Kernel Fusion](https://arxiv.org/abs/2604.22092)
...
### [81] [GICC: A High-Performance Runtime for GPU-Initiated Communication and Coordination in Modern HPC Systems](https://arxiv.org/abs/2604.22126)
...
### [82] [$O(K)$-Approximation Coflow Scheduling in $K$-Core Optical Circuit Switching Networks](https://arxiv.org/abs/2604.22146)
...
### [83] [Accelerating Intra-Node GPU-to-GPU Communication Through Multi-Path Transfers with CUDA Graphs](https://arxiv.org/abs/2604.22228)
...
### [84] [Guess-Verify-Refine: Data-Aware Top-K for Sparse-Attention Decoding on Blackwell via Temporal Correlation](https://arxiv.org/abs/2604.22312)
...
### [85] [A comprehensive evaluation of spatial co-execution on GPUs using MPS and MIG technologies](https://arxiv.org/abs/2604.22430)
...
### [86] [LaissezCloud: Continuous Resource Renegotiation for the Public Cloud](https://arxiv.org/abs/2604.22509)
...
### [87] [Leveraging SIMD for Accelerating Large-number Arithmetic](https://arxiv.org/abs/2604.21566)
...
### [88] [Hardware-Software Co-Design for Event-Driven SNN Deployment on Low-Cost Neuromorphic FPGAs](https://arxiv.org/abs/2604.22179)
...
### [89] [GR-Evolve: Design-Adaptive Global Routing via LLM-Driven Algorithm Evolution](https://arxiv.org/abs/2604.22234)
...
### [90] [AutoINV: Automated Invariant Generation Framework for Formal Verification on High-Level Synthesis Designs](https://arxiv.org/abs/2604.22285)
...
### [91] [HGQ-LUT: Fast LUT-Aware Training and Efficient Architectures for DNN Inference](https://arxiv.org/abs/2604.22293)
...
### [92] [Exploiting pre-optimized kernels with polyhedral transformations for CGRA compilation](https://arxiv.org/abs/2604.22297)
...
### [93] [Microarchitectural Co-Optimization for Sustained Throughput of RISC-V Multi-Lane Chaining Vector Processors](https://arxiv.org/abs/2604.22314)
