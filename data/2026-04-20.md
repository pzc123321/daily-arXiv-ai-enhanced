...
### [54] [SWNet: A Cross-Spectral Network for Camouflaged Weed Detection](https://arxiv.org/abs/2604.16147)
...
### [55] [Breakout-picker: Reducing false positives in deep learning-based borehole breakout characterization from acoustic image logs](https://arxiv.org/abs/2604.16011)
...
### [57] [Ranking XAI Methods for Head and Neck Cancer Outcome Prediction](https://arxiv.org/abs/2604.16034)
...
### [59] [Elucidating the SNR-t Bias of Diffusion Probabilistic Models](https://arxiv.org/abs/2604.16044)
...
### [83] [The Relic Condition: When Published Scholarship Becomes Material for Its Own Replacement](https://arxiv.org/abs/2604.16116)
...
### [84] [When does a control system compute? Digital, mechanical and open-loop systems](https://arxiv.org/abs/2604.16162)
...
### [85] [DeepER-Med: Advancing Deep Evidence-Based Research in Medicine Through Agentic AI](https://arxiv.org/abs/2604.15456)
...
### [86] [GIST: Multimodal Knowledge Extraction and Spatial Grounding via Intelligent Semantic Topology](https://arxiv.org/abs/2604.15495)
...
### [87] [Bureaucratic Silences: What the Canadian AI Register Reveals, Omits, and Obscures](https://arxiv.org/abs/2604.15514)
...
### [88] [LACE: Lattice Attention for Cross-thread Exploration](https://arxiv.org/abs/2604.15529)
...
### [91] [Bilevel Optimization of Agent Skills via Monte Carlo Tree Search](https://arxiv.org/abs/2604.15709)
...
### [92] [The World Leaks the Future: Harness Evolution for Future Prediction Agents](https://arxiv.org/abs/2604.15719)
...
### [93] [LLM Reasoning Is Latent, Not the Chain of Thought](https://arxiv.org/abs/2604.15726)
*Wenshuo Wang*
...
### [94] [Structured Abductive-Deductive-Inductive Reasoning for LLMs via Algebraic Invariants](https://arxiv.org/abs/2604.15727)
...
### [95] [KWBench: Measuring Unprompted Problem Recognition in Knowledge Work](https://arxiv.org/abs/2604.15760)
*Ankit Maloo*
...
### [96] [Stein Variational Black-Box Combinatorial Optimization](https://arxiv.org/abs/2604.15837)
...
### [97] [Discover and Prove: An Open-source Agentic Framework for Hard Mode Automated Theorem Proving in Lean 4](https://arxiv.org/abs/2604.15839)
...
### [98] [Experience Compression Spectrum: Unifying Memory, Skills, and Rules in LLM Agents](https://arxiv.org/abs/2604.15877)
...
### [99] [Towards Rigorous Explainability by Feature Attribution](https://arxiv.org/abs/2604.15898)
...
### [100] [Integrating Graphs, Large Language Models, and Agents: Reasoning and Retrieval](https://arxiv.org/abs/2604.15951)
...
### [101] [Weak-Link Optimization for Multi-Agent Reasoning and Collaboration](https://arxiv.org/abs/2604.15972)
...
### [102] [ReactBench: A Benchmark for Topological Reasoning in MLLMs on Chemical Reaction Diagrams](https://arxiv.org/abs/2604.15994)
...
### [103] [MEDLEY-BENCH: Scale Buys Evaluation but Not Control in AI Metacognition](https://arxiv.org/abs/2604.16009)
...
### [104] [SocialGrid: A Benchmark for Planning and Social Reasoning in Embodied Multi-Agent Systems](https://arxiv.org/abs/2604.16022)
...
### [105] [MARCH: Multi-Agent Radiology Clinical Hierarchy for CT Report Generation](https://arxiv.org/abs/2604.16175)
...
### [107] [Learning to Reason with Insight for Informal Theorem Proving](https://arxiv.org/abs/2604.16278)
...
### [108] [Using Large Language Models and Knowledge Graphs to Improve the Interpretability of Machine Learning Models in Manufacturing](https://arxiv.org/abs/2604.16280)
...
### [109] [DataCenterGym: A Physics-Grounded Simulator for Multi-Objective Data Center Scheduling](https://arxiv.org/abs/2604.15594)
...
### [110] [BlockRaFT: A Distributed Framework for Fault-Tolerant and Scalable Blockchain Nodes](https://arxiv.org/abs/2604.15731)
...
### [111] [Accuracy Is Speed: Towards Long-Context-Aware Routing for Distributed LLM Serving](https://arxiv.org/abs/2604.15732)
...
### [112] [cuNNQS-SCI: A Fully GPU-Accelerated Framework for High-Performance Configuration Interaction Selection withNeural Network QQantum States](https://arxiv.org/abs/2604.15768)
...
### [113] [CroSatFL: Energy-Efficient Federated Learning with Cross-Aggregation for Satellite Edge Computing](https://arxiv.org/abs/2604.15779)
...
### [114] [Breaking the Training Barrier of Billion-Parameter Universal Machine Learning Interatomic Potentials](https://arxiv.org/abs/2604.15821)
...
### [115] [New Kids: An Architecture and Performance Investigation of Second-Generation Serverless Platforms](https://arxiv.org/abs/2604.15916)
...
### [116] [Continuous benchmarking: Keeping pace with an evolving ecosystem of models and technologies](https://arxiv.org/abs/2604.15919)
...
### [117] [T-RBFT: A Scalable and Efficient Byzantine Consensus Based on Trusted Execution Environment for Consortium Blockchain](https://arxiv.org/abs/2604.16053)
...
### [118] [Robust Synchronisation for Federated Learning in The Face of Correlated Device Failure](https://arxiv.org/abs/2604.16090)
...
### [119] [Compositional Design, Implementation, and Verification of Swarms (Technical Report)](https://arxiv.org/abs/2604.16097)
...
### [120] [Logarithmic-Time Geodesically Convex Decomposition in Programmable Matter](https://arxiv.org/abs/2604.16112)
...
### [121] [Taming Asynchronous CPU-GPU Coupling for Frequency-aware Latency Estimation on Mobile Edge](https://arxiv.org/abs/2604.15357)
...
### [122] [AutoFlows++: Hierarchical Message Flow Mining for System on Chip Designs](https://arxiv.org/abs/2604.15359)
...
### [123] [GEN-Graph: Heterogeneous PIM Accelerator for General Computational Patterns in Graph-based Dynamic Programming](https://arxiv.org/abs/2604.15361)
...
### [124] [Photonic AI: A Hybrid Diffractive Holographic Neural System for Passive Optical Real-Time Image Classification](https://arxiv.org/abs/2604.15364)
...
### [125] [VeriCWEty: Embedding enabled Line-Level CWE Detection in Verilog](https://arxiv.org/abs/2604.15375)
...
### [126] [Fleet: Hierarchical Task-based Abstraction for Megakernels on Multi-Die GPUs](https://arxiv.org/abs/2604.15379)
...
### [127] [Exploring LLM-based Verilog Code Generation with Data-Efficient Fine-Tuning and Testbench Automation](https://arxiv.org/abs/2604.15388)
...
### [128] [EasyRider: Mitigating Power Transients in Datacenter-Scale Training Workloads](https://arxiv.org/abs/2604.15522)
...
### [129] [Spec2Cov: An Agentic Framework for Code Coverage Closure of Digital Hardware Designs](https://arxiv.org/abs/2604.15606)
...
### [130] [Overmind NSA: A Unified Neuro-Symbolic Computing Architecture with Approximate Nonlinear Activations and Preemptive Memory Bypass](https://arxiv.org/abs/2604.15623)
...
### [131] [HYPERHEURIST: A Simulated Annealing-Based Control Framework for LLM-Driven Code Generation in Optimized Hardware Design](https://arxiv.org/abs/2604.15642)
...
### [132] [Understanding Inference-Time Token Allocation and Coverage Limits in Agentic Hardware Verification](https://arxiv.org/abs/2604.15657)
...
### [133] [CIMple: Standard-cell SRAM-based CIM with LUT-based split softmax for attention acceleration](https://arxiv.org/abs/2604.15944)
...
### [134] [MemExplorer: Navigating the Heterogeneous Memory Design Space for Agentic Inference NPUs](https://arxiv.org/abs/2604.16007)
...
### [135] [Co-Design of CNN Accelerators for TinyML using Approximate Matrix Decomposition](https://arxiv.org/abs/2604.16113)
