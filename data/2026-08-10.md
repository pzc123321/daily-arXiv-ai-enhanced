...
### [1] [Toward surface-based registration of a virtual preoperative cutting guide onto the mandible for reconstruction surgery](https://arxiv.org/abs/2608.06599)
...
### [74] [Rendezvous of Mobile Deterministic Automata in Graphs](https://arxiv.org/abs/2608.06482)
...
### [75] [Cascade: Exploiting SLO-Aware latency budget for fair and high goodput LLM inference serving](https://arxiv.org/abs/2608.06557)
...
### [76] [MARS: A Monte Carlo Tree Search-based Adaptive and Responsive Scheduler](https://arxiv.org/abs/2608.06629)
...
### [77] [DGEMM with Ozaki Scheme I/II on FP4 Tensor Cores: A Base-13 E2M1 Limb Representation](https://arxiv.org/abs/2608.06812)
...
### [78] [StateFlow: Sequence Pipeline Parallelism for Long-Context Modeling with Linear Recurrence](https://arxiv.org/abs/2608.06838)
...
### [79] [Stream Learning: Partition-Fair Gossip Learning Without Tokens](https://arxiv.org/abs/2608.06946)
...
### [80] [A Self-Adaptive Extensible CEP framework for the Cloud-Edge Continuum](https://arxiv.org/abs/2608.06966)
...
### [81] [A Kubernetes Scheduler Plugin for Cluster-Wide Placement Optimisation](https://arxiv.org/abs/2608.06987)
...
### [82] [HiSparse: Scaling Sparse-Attention Decoding with Hierarchical KV Cache Management](https://arxiv.org/abs/2608.07009)
...
### [83] [Scalable High-Fidelity Macromolecular Docking for GPU-Accelerated Supercomputers](https://arxiv.org/abs/2608.07078)
...
### [84] [Fast end-to-end cloud application cold-start with initscripts](https://arxiv.org/abs/2608.07358)
...
### [86] [Towards Multi-Label Graph Foundation Models: from Single-Vector Representation Learning to Multi-Semantic Basis Learning](https://arxiv.org/abs/2608.06394)
...
### [87] [EntropyMoE: Entropy-Aware Sparse Expert Routing for Tokenizer-Free LLMs](https://arxiv.org/abs/2608.06398)
...
### [88] [Beyond Routing Weights: Faithful Response-Level Interpretation of Mixture-of-Experts Reward Models via Contribution Contrast](https://arxiv.org/abs/2608.06400)
...
### [89] [Interpretable Unsupervised Community Detection with LLM-Symbolized Structured Processes](https://arxiv.org/abs/2608.06402)
...
### [90] [ADIAS: Automated Design of Interactive Agentic Systems](https://arxiv.org/abs/2608.06410)
...
### [91] [Learning to Predict Middle-Layer Attention in MLLMs for Visual Token Prunin](https://arxiv.org/abs/2608.06411)
...
### [92] [WebGrader: Training LLMs for Web Development with Self-Evolving Programmatic Grader](https://arxiv.org/abs/2608.06474)
...
### [93] [Can MLLMs Decode the Creative Leap? Introducing C4 for Cross-Concept Understanding](https://arxiv.org/abs/2608.06501)
...
### [95] [TaskSense: Focusing on What Matters in World Models](https://arxiv.org/abs/2608.06544)
...
### [96] [Divergent Response Modes in Frontier Language Models Under Steering Pressure](https://arxiv.org/abs/2608.06578)
*Ali Jalal-Kamali*
...
### [97] [Automated item evaluation: Predicting item acceptance and rejection using LLM-generated critiques](https://arxiv.org/abs/2608.06609)
...
### [98] [NxN E-valuation: Hypothesis Certification via a Conformal CRT Null](https://arxiv.org/abs/2608.06621)
*Bin Wang,Yan Zhong*
...
### [99] [Shape Your Feed: An LLM-based Agentic System for Conversational Recommendation](https://arxiv.org/abs/2608.06632)
...
### [100] [TRACE: A Multi-Layer Benchmark for Human AI Controller Coordination Under Drift and Failure](https://arxiv.org/abs/2608.06657)
...
### [101] [CellWorld: From Gene-Level Reconstruction to Latent Cell Prediction in Spatial Transcriptomics Foundation Models](https://arxiv.org/abs/2608.06659)
...
### [102] [Vehicle routing problem using deep reinforcement learning - A case study about truck planning in the industry](https://arxiv.org/abs/2608.06668)
...
### [103] [A Multi-Agent Framework for Automated Coarse-Grained Molecular Dynamics of Polymers](https://arxiv.org/abs/2608.06694)
...
### [104] [AgentPatch: Coarse-to-Fine Weak-Task Repair for Merging Agentic Multimodal Large Language Models](https://arxiv.org/abs/2608.06699)
...
### [105] [WebRider: Persona-Conditioned Intent Controllers for Live-Web Assistance](https://arxiv.org/abs/2608.06704)
...
### [106] [MolBioKG: Grounding Out-of-Graph Molecules in Biomedical Knowledge Graphs via Multi-Resolution Structural Anchoring](https://arxiv.org/abs/2608.06713)
...
### [107] [The Optimizer Is the Agent: Reasoning-Driven Search across Prompts, Programs, and ML Workflows](https://arxiv.org/abs/2608.06714)
...
### [108] [bioMoR: Biology-Guided Mixture-of-Recursions for Effective Genomic Learning](https://arxiv.org/abs/2608.06727)
...
### [109] [From Cheap Fakes to Pure Synthesis: Addressing the New Era of T2V Fake News Videos](https://arxiv.org/abs/2608.06732)
...
### [110] [IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents](https://arxiv.org/abs/2608.06735)
...
### [111] [MemPrism: Task-Conditioned Relational Memory Views for Long-Horizon Agents](https://arxiv.org/abs/2608.06745)
...
### [112] [Mind the Gap: A Dual Knowledge Graph Framework for Unified Multi-task User Intent Inference](https://arxiv.org/abs/2608.06752)
...
### [113] [Capek 0.5: An Execution-Centric Vision-Language Model for Embodied Intelligence](https://arxiv.org/abs/2608.06756)
...
### [114] [LiFTER: A Grounded Neuro-Symbolic Microscope for Continuous-Time Dynamic Graph Forecasting](https://arxiv.org/abs/2608.06765)
...
### [115] [Surg-UniWorld: A Unified Surgical World Model with Multimodal Control Experts](https://arxiv.org/abs/2608.06770)
...
### [127] [Blind to the Pivotal Vote: Aggregate Independence Metrics Miss Where Verification Actually Helps](https://arxiv.org/abs/2608.06940)
*Yang Shu*
...
### [128] [LMM Modality Transfer: A Pre-requisite for Autonomous GIS Agents](https://arxiv.org/abs/2608.06948)
...
### [129] [Does Splitting a Triage Decision Across Agents Hide Bias or Help Catch It? A Multi-Agent Simulation Study of LLM-Based Resource Allocation Under Audit Capacity Constraints](https://arxiv.org/abs/2608.06949)
*Paul-Peter Arslan*
...
### [130] [Critical Acclaim Orientation in Large Language Models: Evidence from Film Preference Elicitation](https://arxiv.org/abs/2608.06955)
...
### [131] [CAi Copilot: Reducing Operational Workload in Molecular Design through Intent-Driven Agentic Workflows](https://arxiv.org/abs/2608.06961)
...
### [132] [Learning in Deep Networks under Dale's Constraint](https://arxiv.org/abs/2608.06963)
...
### [133] [Finding Usable Weight Mechanisms with Tiled SVD](https://arxiv.org/abs/2608.06969)
...
### [173] [A Low-Latency ASIC Architecture for Real-Time Line Segment Detection](https://arxiv.org/abs/2608.06439)
...
### [174] [Retention-Aware RISC-V ISA Extension and Memory Controller on FPGA for MLC NVM](https://arxiv.org/abs/2608.06725)
...
### [175] [HLSmith: An Expert-Guided Agentic Framework for C/C++-to-HLS Translation](https://arxiv.org/abs/2608.06791)
...
### [176] [G-Power: Architecture-level GPU Power Modeling with Aggregated Knowledge Foundations from Known GPUs](https://arxiv.org/abs/2608.06870)
...
### [177] [Rethinking Unified Memory for NPU-PIM Systems: Dual-View Memory for Dynamic Inference of LLM](https://arxiv.org/abs/2608.06989)
...
### [178] [Dual-Node NVIDIA DGX Spark over Tailscale: A Remote-Access Testbed for Distributed LLM Training and Cyber-Threat-Intelligence Fine-Tuning](https://arxiv.org/abs/2608.07226)
*Vasanth Iyer*
...
### [179] [Ising Acceleration for Multi-Robot Multi-Target Planning](https://arxiv.org/abs/2608.06803)
