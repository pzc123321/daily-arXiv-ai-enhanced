...
### [100] [vToken: Token-Level Virtualization for Reclaimable KV Caches](https://arxiv.org/abs/2608.13263)
...
### [101] [Dual-Flow Transformers: Decoupling the Primary Prefill Path from Additional Decode Computation](https://arxiv.org/abs/2608.12385)
...
### [102] [Learning to Adapt Cross-Domain Preferences via Meta-LoRA for LLM Personalization](https://arxiv.org/abs/2608.12389)
...
### [103] [Research Assistant: AstraZeneca's Agentic System for R&D](https://arxiv.org/abs/2608.12395)
...
### [104] [Large Language Models Can Follow Instructions, But Not Many at Once: Phase Transitions in Compositional Constraint Satisfaction](https://arxiv.org/abs/2608.12426)
*Mariya I. Vasileva*
...
### [108] [CAS: A Causal Attribution Score for Local and Global Explainable Artificial Intelligence](https://arxiv.org/abs/2608.12555)
...
### [109] [Trie Automata for Constrained Decoding over Large Finite Sets](https://arxiv.org/abs/2608.12574)
...
### [111] [Auditable agentic AI for evidence-grounded thyroid ultrasound diagnosis and reporting](https://arxiv.org/abs/2608.12590)
...
### [112] [DiG-bench: Discovery in Games](https://arxiv.org/abs/2608.12593)
...
### [113] [Dead text or binding clause? Measuring and restoring constraint influence in black-box LLM dialogues](https://arxiv.org/abs/2608.12599)
*Haoyuan Zhu*
...
### [114] [@skills: Attention is all you have](https://arxiv.org/abs/2608.12610)
...
### [115] [Jagged Judges: Epistemic Stability Under Silence, Pressure, and Persistence](https://arxiv.org/abs/2608.12645)
...
### [116] [SteerBench-Work: A Benchmark for Agent Steering at Action Boundaries](https://arxiv.org/abs/2608.12654)
...
### [117] [General Probabilities of Causation with Causal Knowledge](https://arxiv.org/abs/2608.12657)
...
### [118] [Designing AI Pipelines for Decision-Ready ITSM Intelligence](https://arxiv.org/abs/2608.12670)
...
### [119] [On the Expressive Power of Transformers](https://arxiv.org/abs/2608.12671)
...
### [120] [Lines and Ladders: A Context-Aware Multi-Agent Framework for Large-Scale Retail Price Taxonomy](https://arxiv.org/abs/2608.12674)
...
### [121] [Privacy-Preserving RAG by Concealing Sensitive Information from External LLMs](https://arxiv.org/abs/2608.12675)
...
### [122] [The Role of Natural Language Understanding in Multimodal Video-Based Dengue Diagnosis](https://arxiv.org/abs/2608.12677)
...
### [123] [Beyond the Best Guess: Improving LLM Solution Coverage with Evolution Strategies](https://arxiv.org/abs/2608.12679)
...
### [124] [Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence](https://arxiv.org/abs/2608.12743)
...
### [125] [Correct Is Not Governed: Provenance Integrity in Agentic Workflows](https://arxiv.org/abs/2608.12761)
*Jesus Salas*
...
### [126] [PROVE-RT: Generating Mechanized Theorem Prover Scripts for Real-Time Systems using LLMs](https://arxiv.org/abs/2608.12762)
...
### [127] [ARAC: Benchmarking Auto-Research's Alignment and Completeness on End-to-End Researchs](https://arxiv.org/abs/2608.12788)
...
### [128] [CABS+: Efficient and Scalable Model Merging via Conflict-Aware Sparsification and Adaptive Weight Allocation](https://arxiv.org/abs/2608.12842)
...
### [129] [Beyond Retrieval: Query-Conditioned Reuse of Long-Horizon Agent Trajectories](https://arxiv.org/abs/2608.12847)
...
### [130] [Practice Makes Unsafe: Skill Misevolution in Self-Improving LLM Agents](https://arxiv.org/abs/2608.12851)
...
### [131] [AI and Consumer Rights in India Working Paper](https://arxiv.org/abs/2608.12863)
...
### [132] [ReflectFact: Self-Reflective Agents for Improving Comprehension and Reasoning in Multi-Hop Fact Verification](https://arxiv.org/abs/2608.12877)
...
### [133] [Predictive Memory Localization: Forecasting Selective Intervention Paths from Internal Signals](https://arxiv.org/abs/2608.12892)
...
### [134] [Agent Behavioral Contracts II: Certifying Compositional Reliability Without Assuming Independence](https://arxiv.org/abs/2608.12895)
...
### [135] [Polish Medical Visual Question Answering: Vision-Language Models Underutilize Visual Evidence](https://arxiv.org/abs/2608.12928)
...
### [136] [FlashDrive: Flash Vision-Language-Action Inference for Autonomous Driving](https://arxiv.org/abs/2608.12932)
...
### [137] [Decomposition of Evidence, Contradiction, and Fragility in Perturbation Responses](https://arxiv.org/abs/2608.12935)
*Lei You*
...
### [138] [Moose: Latent concept learning with reasoning-shortcut awareness in $\mathcal{EL}^{++}$](https://arxiv.org/abs/2608.12961)
...
### [139] [OGR-MARL: Option-Guided Residual Multi-Agent Reinforcement Learning for Heterogeneous USV Cooperative Pursuit in Constrained Port Waterways](https://arxiv.org/abs/2608.12995)
...
### [177] [Exponential multi-graylevel computational-weighted dithering for high-quality binarized Fourier single-pixel imaging](https://arxiv.org/abs/2608.12958)
...
### [178] [ProbSplat: Efficient Probabilistic Hardware for Gaussian Splatting in 3D Scene Reconstruction](https://arxiv.org/abs/2608.13143)
...
### [179] [Enabling Ultra-Low-Power Always-On Feedforward Leakage Suppression Logic Circuits with FDSOI](https://arxiv.org/abs/2608.13189)
...
### [180] [Offering Microsecond-Scale Cross-VM Core Elasticity on Colocated Lightweight Virtual Machines](https://arxiv.org/abs/2608.12633)
...
### [181] [InFactPlanner: Planning Sustainable Geo-Distributed LLM Data Centers](https://arxiv.org/abs/2608.12915)
...
### [182] [Efficient Randomized LL/SC that Preserves History Independence](https://arxiv.org/abs/2608.12946)
...
### [183] [TEMPO: Makespan-Aware Expert-Parallel Load Balancing Across Memory- and Compute-Bound Regimes](https://arxiv.org/abs/2608.13057)
...
### [184] [Meshlib: In-Process Policy Enforcement for Sidecar-less Service Meshes](https://arxiv.org/abs/2608.13107)
...
### [185] [Validation-Centric AI-Assisted GPU Porting of a 250,000+ Line Legacy Weather Simulation Code](https://arxiv.org/abs/2608.13122)
...
### [186] [LipCache: A Local Inference Proxy with Certified Caching for Edge Image Classification Service](https://arxiv.org/abs/2608.13144)
...
### [187] [Triangle-Free Coloring in LOCAL via Resilient Lovász Local Lemma](https://arxiv.org/abs/2608.13357)
...
### [188] [Fast Tendermint: Speeding Up a Foundational Consensus Protocol](https://arxiv.org/abs/2608.13434)
...
### [189] [OpScale: Operator-level Provisioning and Autoscaling for LLM Serving](https://arxiv.org/abs/2608.13499)
...
### [190] [SCALE-Sim EVA: Design Principles for an Extensible, Visualizable, and Adaptable Accelerator Simulation Framework](https://arxiv.org/abs/2608.12354)
...
### [191] [Lonic: Algorithm-Hardware Co-Design for Energy-Efficient Fully Local Online SNN Training with INT4 Precision](https://arxiv.org/abs/2608.12500)
...
### [192] [GateTruth: Auditing the Rigor of RTL Design Benchmarks via Mutation Testing](https://arxiv.org/abs/2608.12635)
*Meet Bhadra*
...
### [193] [Spec-Driven Hardware Evolution via Executable Contract Refinement and Proof-Guided RTL Update](https://arxiv.org/abs/2608.12684)
...
### [194] [SynAct: A Reasoning-Acting Large Language Model Agent for Adaptive Synthesis Optimization](https://arxiv.org/abs/2608.12751)
...
### [195] [Dryas: A Reprogrammable Engine for High-Speed Interconnect Tracing and Analysis](https://arxiv.org/abs/2608.12934)
...
### [196] [Why Do Prefetchers Fail? Let Agents Answer](https://arxiv.org/abs/2608.13027)
...
### [197] [Potential Applications of HBF in LLM Serving Systems](https://arxiv.org/abs/2608.13127)
...
### [198] [ROLoad-PMP: Securing Sensitive Operations for Kernels and Bare-Metal Firmware](https://arxiv.org/abs/2608.13287)
...
### [199] [YAVIN: A Unified Architecture for Secure Edge Processing in Memory](https://arxiv.org/abs/2608.13496)
