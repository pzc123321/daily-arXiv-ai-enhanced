...
### [53] [GP-Adapter: Gaussian Process CLIP-Adapter for Few-Shot Out-of-Distribution Detection](https://arxiv.org/abs/2606.07102)
...
### [55] [Native3D: End-to-End 3D Scene Generation via Unified Mesh-Texture Modeling and Semantic Alignment](https://arxiv.org/abs/2606.07117)
...
### [91] [Belief-Aware Scheduling for Predictive Wildfire Hazard Mapping under Sparse-Window Telemetry](https://arxiv.org/abs/2606.06917)
...
### [92] [The Three-Ring Architecture: Governing Agents in the Era of On-Platform Organisations](https://arxiv.org/abs/2606.07119)
...
### [93] [Distributed Persistence Domain for Persistent Memory Pooling](https://arxiv.org/abs/2606.07159)
...
### [94] [FP8 is All You Need (Part 1): Debunking Hardware FP64 as the HPC Holy Grail](https://arxiv.org/abs/2606.06510)
*Satoshi Matsuoka*
...
### [95] [DxPTA: An Architecture Design Space Exploration with Optical Dataflow-guided Strategy for HW/SW Co-Design of Photonic Transformer Accelerators](https://arxiv.org/abs/2606.06515)
...
### [96] [P-Cast Precision in FP8 Attention: Sink-Induced Collapse and the Optimality of S=2^8](https://arxiv.org/abs/2606.06521)
*Reed Lau*
...
### [97] [Ablation Study of Block Size, Weight Precision, and Scale Precision in NVFP4 Inference for Low-Power Edge-Efficient Neural Networks](https://arxiv.org/abs/2606.06527)
...
### [98] [Quantized AI Inference on Constrained Embedded Platforms for Small-Satellite Settings](https://arxiv.org/abs/2606.06528)
...
### [99] [RTLScout: Joint Agentic Code and Synthesis Optimization for Efficient Digital Circuits](https://arxiv.org/abs/2606.06530)
...
### [100] [MailoHLS: Multi-Adapter Structure-Aware Learning for Pareto-Driven HLS Pragma Optimization](https://arxiv.org/abs/2606.07246)
...
### [101] [A 65 nm Multi-Modal Bayesian Inference Engine with 16.3 fJ/Sample Calibration-Free GRNG for Risk-Aware At-Home Skin Lesion Screening](https://arxiv.org/abs/2606.07439)
...
### [102] [A 65 nm Trustworthy Hypoglycemia Forecasting Engine Achieving 11.3 nJ per Inference](https://arxiv.org/abs/2606.07455)
...
### [103] [Detecting and Mitigating Bias by Treating Fairness as a Symmetry Operation](https://arxiv.org/abs/2606.06514)
*Nishit Singh*
...
### [104] [DiBS: Diffusion-Informed Branch Selection](https://arxiv.org/abs/2606.06518)
...
### [105] [SafeGene: Reusable Adapters for Transferable Safety Alignment](https://arxiv.org/abs/2606.06519)
...
### [106] [Lean4Agent: Formal Modeling and Verification for Agent Workflow and Trajectory](https://arxiv.org/abs/2606.06523)
...
### [107] [The Sim-to-Real Gap of Foundation Model Agents: A Unified MDP Perspective](https://arxiv.org/abs/2606.07017)
...
### [108] [CrowdMath: A Dataset of Crowdsourced Mathematical Research Discussions](https://arxiv.org/abs/2606.06526)
...
### [109] [Attack Selection in Agentic AI Control Evaluations Meaningfully Decreases Safety](https://arxiv.org/abs/2606.06529)
...
### [110] [CARVE-Q: Quantum-Proposed, Classically Certified Interactive Driving Repair](https://arxiv.org/abs/2606.06531)
*Yifan Wang*
...
### [111] [Position: Don't Just "Fix it in Post": A Science of AI Must Study Training Dynamics](https://arxiv.org/abs/2606.06533)
...
### [112] [Accelerated Fourier SAT (AFSAT): Fully Realising a GPU-based Symmetric Pseudo-Boolean SAT Solver](https://arxiv.org/abs/2606.06641)
...
### [113] [A Study of Parallel Continuous Local Search](https://arxiv.org/abs/2606.06656)
*Cody J Christopher,Charles Gretton*
...
### [114] [AEGIS: A Backup Reflex for Physical AI](https://arxiv.org/abs/2606.06660)
*Josef Chen*
...
### [115] [A Geometric Account of Activation Steering through Angle-Norm Decomposition](https://arxiv.org/abs/2606.06735)
...
### [116] [OpenSkill: Open-World Self-Evolution for LLM Agents](https://arxiv.org/abs/2606.06741)
...
### [117] [AdMem: Advanced Memory for Task-solving Agents](https://arxiv.org/abs/2606.06787)
...
### [118] [Evidence-Based Intelligent Diagnostic and Therapeutic Visualization System with Large Language Models: Multi-Turn Interaction and Multimodal Treatment Plan Generation](https://arxiv.org/abs/2606.06869)
...
### [119] [Workflow-to-Skill: Skill Creation via Routing-Workflow-Semantics-Attachments Decomposition](https://arxiv.org/abs/2606.06893)
...
### [120] [Declarative Skills for AI Agents in Knowledge-Grounded Tool-Use Workflows](https://arxiv.org/abs/2606.06923)
...
### [121] [Quantum-Inspired Trace-Augmented Evidence Selection for Reasoning over Structured Hypothesis Spaces](https://arxiv.org/abs/2606.06941)
...
### [122] [Accounting for Context: Shaping Moral Credences for Value Alignment](https://arxiv.org/abs/2606.06972)
...
### [123] [Exploring Agentic Tool-Calling Decisions via Uncertainty-Aligned Reinforcement Learning](https://arxiv.org/abs/2606.06976)
...
### [124] [Teaching the Way, Not the Answer: Privileged Tutoring Distillation for Multimodal Policy Optimization](https://arxiv.org/abs/2606.07000)
...
### [134] [Online Pandora's Box for Contextual LLM Cascading](https://arxiv.org/abs/2606.07392)
...
### [135] [Act As a Real Researcher: A Suite of Benchmarks Evaluating Frontier LLMs and Agentic Harnesses in Research Lifecycle](https://arxiv.org/abs/2606.07462)
...
### [136] [How AI Agents Reshape Knowledge Work: Autonomy, Efficiency, and Scope](https://arxiv.org/abs/2606.07489)
...
### [137] [StageFrontier: Synchronization-Aware Stage Accounting for Distributed ML Training](https://arxiv.org/abs/2606.06751)
...
### [138] [Terastal: Layer-Variant-based Scheduling for Real-Time Multi-DNN Workloads on Heterogeneous Accelerators](https://arxiv.org/abs/2606.06818)
...
### [139] [Communication Strategy Selection for Multi-GPU 3D FDTD with Convolutional Perfectly Matched Boundary Layers](https://arxiv.org/abs/2606.06910)
*Victory C. Obieke*
...
### [140] [PCCL: Process Group-Aware Scalable and Generic Collective Algorithm Synthesizer](https://arxiv.org/abs/2606.07019)
...
### [141] [Predictive Autoscaling in Cloud-Native and Federated Cloud-Edge Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2606.07046)
...
### [142] [Clairvoyant: Predictive SJF Scheduling to Mitigate Head-of-Line Blocking in Serial LLM Backends](https://arxiv.org/abs/2606.07248)
*Aravind Sundaresan*
...
### [143] [Twelve quick tips for designing AI-driven HPC workflows](https://arxiv.org/abs/2606.07491)
*Jamie J. Alnasir*
